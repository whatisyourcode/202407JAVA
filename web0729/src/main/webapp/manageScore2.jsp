...
String num = request.getParameter("num");     // null이면 insert나 update를 하지 말아야 함.
...
// 학번이 null이 아니면 이미 있는 학번지 아닌지 조회
if (num != null){
	sqlTmp = "select count(*) from score where num = ?"; // 이미 있는 학번 조회 (있으면 1 리턴)
	pstmt = conn.prepareStatement(sqlTmp);
